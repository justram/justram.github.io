...
I'm Jheng-Hong (Matt) Yang, an engineer and researcher building agentic systems around data systems. My recent work explores how strong language models can search, inspect evidence, and reason more effectively, which led to [Pi-serini](https://github.com/justram/pi-serini), a minimal search agent for building reliable, cost-efficient deep-research workflows.
